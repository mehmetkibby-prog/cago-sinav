...
assert(html.includes("V26.32"), "Android UI version was not updated");
assert(workflow.includes("V26.32-Guncelleme-APK"), "APK artifact name was not updated");

console.log("Android V26.32 regression checks passed.");
