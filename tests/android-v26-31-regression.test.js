...
assert(html.includes("V26.31"), "Android UI version was not updated");
assert(workflow.includes("V26.31-Guncelleme-APK"), "APK artifact name was not updated");

console.log("Android V26.31 regression checks passed.");
