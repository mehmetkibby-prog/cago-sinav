...
assert(html.includes("V26.29"), "Android UI version was not updated");
assert(workflow.includes("V26.29-Kalici-Tablet-Duzeltmeleri-APK"), "APK artifact name was not updated");

console.log("Android V26.29 regression checks passed.");
